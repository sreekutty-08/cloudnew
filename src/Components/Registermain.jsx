          ...
          <div className="flex gap-6 flex-wrap justify-center">
            ...
            <div className="flex-1 max-w-sm mx-auto bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl p-6 border border-gray-100 hover:shadow-3xl transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="space-y-3">
                ...
                <textarea value={companyDetails.address} onChange={(e) => handleCompanyChange("address", e.target.value)} className="w-full p-3 border border-gray-200 rounded-lg text-sm resize-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all"rows="3" placeholder="Address" />
